...
namespace Business.Concrete
{
    public class AuthManager : IAuthService
    {
        ...
        public IDataResult<User> GetByMail(string mail)
        {
            ...
            if (user != null)
            {
                return new SuccessDataResult<User>(user, Messages.GetByMailSuccess);
            }
        ...
        {
            var userToUpdate = _userService.Update(id, user);
            ...
            return new ErrorResult(Messages.UpdateUserSuccess);
        }
    }
}
